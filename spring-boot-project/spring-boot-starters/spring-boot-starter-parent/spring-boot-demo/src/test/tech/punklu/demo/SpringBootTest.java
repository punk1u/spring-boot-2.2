...
import tech.punklu.demo.properties.TestYmlProperties;
...
public class SpringBootTest {
	...
	@Autowired
	private TestYmlProperties testYmlProperties;

	@Test
	public void testReadCustomYml(){
		System.out.println(testYmlProperties.getName());
	}
}
